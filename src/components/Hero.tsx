...
import OrbitingNodes from "@/components/ui/OrbitingNodes";
...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            {/* Content */}
            <motion.div
                className="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10 py-28"
            ...
            >
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                        ...
                        >
                            <AnimatedHeroText
                                ...
                                className="text-4xl sm:text-5xl lg:text-[64px] font-bold text-white tracking-[-0.04em] leading-tight"
                            />
                        </motion.div>
                        ...
                        <motion.p
                            ...
                            className="text-white/40 text-base sm:text-lg leading-relaxed max-w-xl mb-8 lg:mx-0"
                        >
                            {t("hero.desc")}
                        </motion.p>
                    ...
                    >
                        {/* Optional glow behind the orbits */}
                        <div className="absolute inset-0 bg-accent-500/5 blur-[100px] rounded-full pointer-events-none" />

                        {/* Scale down slightly to fit well in the column */}
                        <div className="transform scale-90 xl:scale-100 origin-right translate-x-12">
                            <OrbitingNodes />
                        </div>
                    </motion.div>
