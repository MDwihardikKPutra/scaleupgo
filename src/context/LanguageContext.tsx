...
export const translations: Record<Language, Record<string, string>> = {
    id: {
        ...
        "why.val1_title": "Desain Premium",
        "why.val1_sub": "Keunggulan Visual",
        "why.val2_title": "Konversi Tinggi",
        "why.val2_sub": "Berorientasi ROI",
        "why.val3_title": "Support 24/7",
        "why.val3_sub": "Partner Terpercaya",
        ...
        // Problem & Solution
        "ps.label": "Masalah & Solusi",
        "ps.title1": "Hentikan Cara Lama,",
        "ps.title2": "Go Digital",
        "ps.desc": "Ubah tantangan operasional menjadi keuntungan bisnis dengan otomatisasi yang tepat sasaran.",
        "ps.bad_label": "Cara Lama",
        "ps.good_label": "Logika Scale Up",
        "ps.p1": "Balas chat satu per satu, lelah & lambat",
        "ps.p2": "Rekap order di buku, rawan salah hitung",
        "ps.p3": "Pelanggan kabur karena respon kelamaan",
        "ps.s1": "Pesanan otomatis masuk ke dashboard",
        "ps.s2": "Buka 24 Jam tanpa harus standby terus",
        "ps.s3": "Data pelanggan rapi & bisa dianalisis",
        "ps.cta": "Siap transformasi bisnis Anda?",
        "ps.btn": "Konsultasi Strategi Sekarang",
